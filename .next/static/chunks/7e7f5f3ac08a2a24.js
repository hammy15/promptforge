...
Write in active voice with clear, concise language appropriate for {{audience}}.`,variables:[{name:"document_type",default:"Strategic Analysis",description:"Type of document",type:"select",options:["Strategic Analysis","Investment Recommendation","Market Research","Business Case","Project Proposal","Risk Assessment","Due Diligence Report"]},{name:"subject",default:"",description:"Subject matter",type:"text"},{name:"audience",default:"Executive Leadership",description:"Target audience",type:"select",options:["Executive Leadership","Board of Directors","Investment Committee","External Stakeholders","Cross-functional Team"]},{name:"objective",default:"",description:"Primary objective",type:"text"},{name:"recommendation",default:"",description:"Key recommendation (brief)",type:"text"},{name:"length",default:"1 page",description:"Target length",type:"select",options:["Half page","1 page","2 pages"]},{name:"tone",default:"Professional",description:"Writing tone",type:"select",options:["Professional","Formal","Persuasive","Neutral/Analytical"]}],tags:["executive-summary","communication","writing","professional"],difficulty:"beginner",estimatedTime:"10 min",outputFormats:["memo","pdf"],useCases:["Report writing","Proposal submission","Decision support"]}];e.s(["PROMPT_TEMPLATES",0,t,"TEMPLATE_CATEGORIES",0,[{id:"all",name:"All Templates",icon:"✨",slug:"all",color:"#d4a853"},{id:"Financial Analysis",name:"Financial Analysis",icon:"📊",slug:"financial-analysis",color:"#d4a853"},{id:"Investment Research",name:"Investment Research",icon:"🔍",slug:"investment-research",color:"#14b8a6"},{id:"Strategy & Planning",name:"Strategy & Planning",icon:"⚡",slug:"strategy-planning",color:"#8b5cf6"},{id:"M&A & Deal Work",name:"M&A & Deal Work",icon:"🤝",slug:"ma-deal-work",color:"#f97316"},{id:"Professional Reporting",name:"Professional Reporting",icon:"📑",slug:"professional-reporting",color:"#627d98"}]])},31814,e=>{"use strict";var t=e.i(43476),a=e.i(22016),i=e.i(1196),n=e.i(71645);function r({prompt:e,onClick:n,href:r}){let s=(0,t.jsx)("div",{className:"group p-5 rounded-xl border border-[#1e3a5f] bg-[#0f2137] hover:border-[#d4a853] hover:bg-[#162a45] transition-all cursor-pointer",children:(0,t.jsxs)("div",{className:"flex items-start gap-4",children:[(0,t.jsx)("div",{className:"w-12 h-12 rounded-xl bg-gradient-to-br from-[#d4a853] to-[#b8953f] flex items-center justify-center text-2xl shrink-0",children:e.icon}),(0,t.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsx)("h3",{className:"font-semibold text-white group-hover:text-[#d4a853] transition-colors truncate",children:e.name}),e.isCustom&&(0,t.jsx)("span",{className:"text-xs px-1.5 py-0.5 rounded bg-[#14b8a6]/20 text-[#14b8a6]",children:"Custom"})]}),(0,t.jsx)("p",{className:"text-sm text-[#64748b] line-clamp-2 mt-1",children:e.description}),(0,t.jsxs)("div",{className:"flex items-center gap-2 mt-3 flex-wrap",children:[e.difficulty&&(0,t.jsx)("span",{className:`badge badge-${e.difficulty}`,children:e.difficulty}),e.estimatedTime&&(0,t.jsx)("span",{className:"text-xs text-[#64748b]",children:e.estimatedTime}),e.targetLLM&&(0,t.jsx)("span",{className:"text-xs px-1.5 py-0.5 rounded bg-[#8b5cf6]/20 text-[#8b5cf6]",children:e.targetLLM}),e.outputFormats?.includes("excel")&&(0,t.jsx)("span",{className:"badge badge-excel text-xs",children:"Excel"}),e.outputFormats?.includes("powerpoint")&&(0,t.jsx)("span",{className:"badge badge-powerpoint text-xs",children:"PPT"})]}),e.author&&(0,t.jsxs)("div",{className:"flex items-center gap-2 mt-2 text-xs text-[#64748b]",children:[(0,t.jsxs)("span",{children:["by ",e.author]}),e.updatedAt&&(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("span",{children:"•"}),(0,t.jsx)("span",{children:e.updatedAt})]})]})]}),(0,t.jsx)(i.Icons.arrowRight,{className:"w-5 h-5 text-[#64748b] group-hover:text-[#d4a853] transition-colors shrink-0"})]})});return r?(0,t.jsx)(a.default,{href:r,children:s}):(0,t.jsx)("div",{onClick:n,children:s})}var s=e.i(52393);function o({prompts:e,showCategories:a=!0,showSearch:o=!0,onSelectPrompt:c,linkPrefix:l="/playground?template="}){let[m,p]=(0,n.useState)("all"),[d,u]=(0,n.useState)(""),[y,g]=(0,n.useState)("grid"),h=(0,n.useMemo)(()=>e||s.PROMPT_TEMPLATES.map(e=>({id:e.id,name:e.name,description:e.description,category:e.categorySlug,icon:e.icon,difficulty:e.difficulty,estimatedTime:e.estimatedTime,outputFormats:e.outputFormats,isCustom:!1})),[e]),v=(0,n.useMemo)(()=>h.filter(e=>{let t="all"===m||e.category===m,a=""===d||e.name.toLowerCase().includes(d.toLowerCase())||e.description.toLowerCase().includes(d.toLowerCase());return t&&a}),[h,m,d]);return(0,t.jsxs)("div",{className:"space-y-6",children:[(0,t.jsxs)("div",{className:"flex flex-col md:flex-row md:items-center justify-between gap-4",children:[o&&(0,t.jsxs)("div",{className:"relative flex-1 max-w-md",children:[(0,t.jsx)(i.Icons.search,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#64748b]"}),(0,t.jsx)("input",{type:"text",placeholder:"Search prompts...",value:d,onChange:e=>u(e.target.value),className:"w-full pl-10 pr-4 py-2 bg-[#0a1929] border border-[#1e3a5f] rounded-lg text-sm text-white placeholder-[#64748b] focus:border-[#d4a853] focus:outline-none"})]}),(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsxs)("span",{className:"text-sm text-[#64748b]",children:[v.length," prompts"]}),(0,t.jsxs)("div",{className:"flex rounded-lg border border-[#1e3a5f] overflow-hidden",children:[(0,t.jsx)("button",{onClick:()=>g("grid"),className:`p-2 ${"grid"===y?"bg-[#1e3a5f] text-white":"text-[#64748b] hover:text-white"}`,children:(0,t.jsx)("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"})})}),(0,t.jsx)("button",{onClick:()=>g("list"),className:`p-2 ${"list"===y?"bg-[#1e3a5f] text-white":"text-[#64748b] hover:text-white"}`,children:(0,t.jsx)("svg",{className:"w-4 h-4",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})})]})]})]}),a&&(0,t.jsxs)("div",{className:"flex gap-2 overflow-x-auto pb-2",children:[(0,t.jsx)("button",{onClick:()=>p("all"),className:`px-4 py-2 rounded-lg text-sm whitespace-nowrap transition-all ${"all"===m?"bg-[rgba(212,168,83,0.15)] text-[#d4a853] border border-[rgba(212,168,83,0.3)]":"text-[#94a3b8] hover:text-white hover:bg-[#162a45]"}`,children:"All Prompts"}),s.TEMPLATE_CATEGORIES.map(e=>(0,t.jsxs)("button",{onClick:()=>p(e.id),className:`px-4 py-2 rounded-lg text-sm whitespace-nowrap transition-all ${m===e.id?"bg-[rgba(212,168,83,0.15)] text-[#d4a853] border border-[rgba(212,168,83,0.3)]":"text-[#94a3b8] hover:text-white hover:bg-[#162a45]"}`,children:[(0,t.jsx)("span",{className:"mr-2",children:e.icon}),e.name]},e.id))]}),v.length>0?(0,t.jsx)("div",{className:"grid"===y?"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4":"space-y-3",children:v.map(e=>(0,t.jsx)(r,{prompt:e,href:c?void 0:`${l}${e.id}`,onClick:c?()=>c(e):void 0},e.id))}):(0,t.jsxs)("div",{className:"text-center py-12",children:[(0,t.jsx)("div",{className:"w-16 h-16 rounded-full bg-[#1e3a5f] flex items-center justify-center mx-auto mb-4",children:(0,t.jsx)(i.Icons.search,{className:"w-8 h-8 text-[#64748b]"})}),(0,t.jsx)("h3",{className:"text-lg font-semibold text-white mb-2",children:"No prompts found"}),(0,t.jsx)("p",{className:"text-[#64748b]",children:"Try adjusting your search or filter criteria"})]})]})}function c(){return(0,t.jsxs)("main",{className:"min-h-screen",children:[(0,t.jsx)("div",{className:"fixed inset-0 bg-gradient-mesh pointer-events-none"}),(0,t.jsxs)("nav",{className:"relative z-10 flex items-center justify-between px-6 py-4 border-b border-[#1e3a5f]",children:[(0,t.jsxs)("div",{className:"flex items-center gap-8",children:[(0,t.jsxs)(a.default,{href:"/",className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-10 h-10 rounded-xl bg-gradient-to-br from-[#d4a853] to-[#b8953f] flex items-center justify-center",children:(0,t.jsx)(i.Icons.chart,{className:"w-6 h-6 text-[#0a1929]"})}),(0,t.jsxs)("span",{className:"text-xl font-bold",children:[(0,t.jsx)("span",{className:"text-[#d4a853]",children:"Prompt"}),(0,t.jsx)("span",{className:"text-white",children:"Forge"})]})]}),(0,t.jsxs)("div",{className:"hidden md:flex items-center gap-1",children:[(0,t.jsx)(a.default,{href:"/",className:"px-4 py-2 text-[#94a3b8] hover:text-white transition-colors rounded-lg hover:bg-[#162a45]",children:"Dashboard"}),(0,t.jsx)(a.default,{href:"/prompts",className:"px-4 py-2 text-white font-medium rounded-lg bg-[rgba(212,168,83,0.1)]",children:"Prompts"}),(0,t.jsx)(a.default,{href:"/prompts/create",className:"px-4 py-2 text-[#94a3b8] hover:text-white transition-colors rounded-lg hover:bg-[#162a45]",children:"Create"}),(0,t.jsx)(a.default,{href:"/playground",className:"px-4 py-2 text-[#94a3b8] hover:text-white transition-colors rounded-lg hover:bg-[#162a45]",children:"Builder"})]})]}),(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("button",{className:"p-2 text-[#64748b] hover:text-white transition-colors",children:(0,t.jsx)(i.Icons.settings,{className:"w-5 h-5"})}),(0,t.jsx)("div",{className:"w-8 h-8 rounded-full bg-gradient-to-br from-[#d4a853] to-[#b8953f] flex items-center justify-center text-[#0a1929] text-sm font-semibold",children:"H"})]})]}),(0,t.jsxs)("div",{className:"relative z-10 px-6 py-8 max-w-7xl mx-auto",children:[(0,t.jsxs)("div",{className:"flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("h1",{className:"text-3xl font-bold text-white mb-2",children:"Available Prompts"}),(0,t.jsx)("p",{className:"text-[#94a3b8]",children:"Browse our library of expert-crafted prompts or your custom creations."})]}),(0,t.jsxs)(a.default,{href:"/prompts/create",className:"btn-primary inline-flex items-center gap-2",children:[(0,t.jsx)(i.Icons.plus,{className:"w-5 h-5"}),"Create Custom Prompt"]})]}),(0,t.jsxs)("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4 mb-8",children:[(0,t.jsxs)("div",{className:"card p-4",children:[(0,t.jsx)("div",{className:"text-2xl font-bold text-[#d4a853] tabular-nums",children:"18"}),(0,t.jsx)("div",{className:"text-sm text-[#64748b]",children:"Finance Templates"})]}),(0,t.jsxs)("div",{className:"card p-4",children:[(0,t.jsx)("div",{className:"text-2xl font-bold text-[#14b8a6] tabular-nums",children:"0"}),(0,t.jsx)("div",{className:"text-sm text-[#64748b]",children:"Custom Prompts"})]}),(0,t.jsxs)("div",{className:"card p-4",children:[(0,t.jsx)("div",{className:"text-2xl font-bold text-[#8b5cf6] tabular-nums",children:"5"}),(0,t.jsx)("div",{className:"text-sm text-[#64748b]",children:"Categories"})]}),(0,t.jsxs)("div",{className:"card p-4",children:[(0,t.jsx)("div",{className:"text-2xl font-bold text-[#f97316] tabular-nums",children:"6"}),(0,t.jsx)("div",{className:"text-sm text-[#64748b]",children:"Target LLMs"})]})]}),(0,t.jsx)("div",{className:"card p-6",children:(0,t.jsx)(o,{showCategories:!0,showSearch:!0})})]})]})}e.s(["default",()=>c],31814)}]);