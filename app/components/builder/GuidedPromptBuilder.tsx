    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a1929] to-[#0f2137]">
      ...
      {state.step >= 3 && !showPreview && (
        <button
          ...
          className="hidden md:flex fixed right-6 bottom-6 items-center gap-2 px-4 py-3 rounded-xl bg-[#1e3a5f] text-white hover:bg-[#2d4a6f] transition-colors shadow-lg"
        >
